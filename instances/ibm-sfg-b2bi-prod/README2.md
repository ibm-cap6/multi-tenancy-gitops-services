...
rules:
  ...
  - apiGroups: ['','batch']
    resources: ['secrets','configmaps','persistentvolumes','persistentvolumeclaims','pods','services','cronjobs']
...
`test.image.tag          `                     | helm test and cleanup docker image tag                               | `1.1.36`
